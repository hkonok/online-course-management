...
<div class="controls">
    <input type="text" class="input-xlarge" name="question_options_select_one[]" id="a"
           <?php if(isset($type_id)&&($type_id==1 || $type_id==9)) echo "value='".strtok($options,"|")."'"; ?>
           >
...
<div class="controls">
    <input type="text" class="input-xlarge" name="question_options_select_one[]" id="b"
           <?php if(isset($type_id)&&($type_id==1 || $type_id==9)) echo "value='".strtok("|")."'"; ?>
           >
    <a class="btn btn-mini btn-success correct_answer_for_select-one">Correct Answer?</a>
    <span class="confirmation-for-right-options-select-one" style="display:none">ok</span>
    <br/><br/>
...
<div class="controls">
    <input type="text" class="input-xlarge" name="question_options_select_one[]" id="c"
           <?php if(isset($type_id)&&($type_id==1 || $type_id==9)) echo "value='".strtok("|")."'"; ?>
           >
    <a class="btn btn-mini btn-success correct_answer_for_select-one">Correct Answer?</a>
    <span class="confirmation-for-right-options-select-one" style="display:none">ok</span>
...
<div class="controls">
    <input type="text" class="input-xlarge" name="question_options_select_one[]" id="d"
           <?php if(isset($type_id)&&($type_id==1 || $type_id==9)) echo "value='".strtok("|")."'"; ?>
           >
    <a class="btn btn-mini btn-success correct_answer_for_select-one">Correct Answer?</a>
    <span class="confirmation-for-right-options-select-one" style="display:none">ok</span>
...
<div class="controls">
    <input type="text" class="input-xlarge" name="question_options_select_one[]" id="e"
           <?php if(isset($type_id)&&($type_id==1 || $type_id==9)) echo "value='".strtok("|")."'"; ?>
           >
    <a class="btn btn-mini btn-success correct_answer_for_select-one">Correct Answer?</a>
    <span class="confirmation-for-right-options-select-one" style="display:none">ok</span>
