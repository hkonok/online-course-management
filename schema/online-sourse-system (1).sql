...
--
-- Host: localhost
-- Generation Time: Sep 18, 2012 at 09:09 PM
...
--
-- Table structure for table `question_subset`
--

CREATE TABLE IF NOT EXISTS `question_subset` (
...
--
-- Dumping data for table `question_subset`
--
...
INSERT INTO `three-blank_completion_questions` (`id`, `question`, `blank_one_options`, `blank_two_options`, `blank_three_options`, `blank_one_correct_answer`, `blank_two_correct_answer`, `blank_three_correct_answer`, `question_set_for_practice`, `question_set_for_mock`, `for_practice`, `for_mock`, `sequence_in_practice`, `sequence_in_mock`) VALUES
(6, 'Who am I?', 'b|a|c', 'f|d|e', 'h|g|i', 'a', 'd', 'g', 'B', 'D', 'Yes', 'Yes', 1, 1),
(7, 'Who is this?', 'a|b|c', 'e|d|f', 'h|g|i', 'b', 'd', 'g', '', 'C', 'No', 'Yes', 0, 2);
...
INSERT INTO `user_basic_info` (`id`, `email`, `password`, `phone_num`) VALUES
(1, 'salehwithDM@gmail.com', 'ghunpoka', 1725566632),
(2, 'rabbyalam@gmail.com', 'rabby29', 1710358519),
(3, 'cse_konok@yahoo.com', 'konok123', 1710358518);
